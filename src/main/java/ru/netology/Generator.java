...
public class Generator {
    ...
    public static void generateABC() {
        new Thread(() -> {
        ...
        new Thread(() -> {
            ...
            System.out.println("The maximum number of letters a (" + maxTextABC.getCount() + "):\n" + maxTextABC.getText() + "\n");
        }).start();
        ...
        new Thread(() -> {
            ...
            System.out.println("The maximum number of letters b (" + maxTextABC.getCount() + "):\n" + maxTextABC.getText() + "\n");
        }).start();
        ...
        new Thread(() -> {
            ...
            System.out.println("The maximum number of letters c (" + maxTextABC.getCount() + "):\n" + maxTextABC.getText() + "\n");
        }).start();
